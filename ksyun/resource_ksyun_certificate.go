/*
Provides an ksyun_certificate resource.
...
ksyun_certificate can be imported using the id, e.g.

```
$ terraform import ksyun_certificate.default 67b91d3c-c363-4f57-b0cd-xxxxxxxxxxxx
```
*/
package ksyun
