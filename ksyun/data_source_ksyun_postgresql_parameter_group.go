/*
Query ksyun postgresql parameter group information
...
```hcl
		...
		data "ksyun_postgresql_parameter_group" "foo" {
			...
			// if you give db_parameter_group_id will return the single postgresql parameter group
			// if you don't give this value, it will return a list of postgresql parameter groups
...
func dataSourceKsyunPostgresqlParameterGroup() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceKsyunPostgresqlParameterGroupRead,
		Schema: map[string]*schema.Schema{
			...
			"db_parameter_groups": {
				...
				Computed:    true,
				Description: "An information list of postgresql db parameter groups. Each element contains the following attributes:",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"db_parameter_group_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The postgresql db parameter group id.",
						},
						"db_parameter_group_name": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The postgresql db parameter group name.",
						},
						"description": {
							Type:        schema.TypeString,
							Computed:    true,
						...
						"engine": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The db parameter group adapts to what postgresql engine.",
						},
						"engine_version": {
							Type:        schema.TypeString,
							Computed:    true,
...
// dataSourceKsyunPostgresqlParameterGroupRead will read data source from ksyun
func dataSourceKsyunPostgresqlParameterGroupRead(d *schema.ResourceData, meta interface{}) error {
	postgresqlParameterSrv := NewPostgresqlParameterSrv(meta.(*KsyunClient))

	var (
		r           = dataSourceKsyunPostgresqlParameterGroup()
	...
	if _, ok := reqParameters["DBParameterGroupId"]; ok {
		...
		sdkResponse, err = postgresqlParameterSrv.describeDBParameterGroupAll(reqParameters)
		if err != nil {
			return err
		}
	}
