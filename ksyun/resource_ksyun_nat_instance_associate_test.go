...
func TestAccKsyunNatInstanceAssociation_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		IDRefreshName: "ksyun_nat_instance_associate.foo",
		Providers:     testAccProviders,
		CheckDestroy:  testAccCheckNatInstanceAssociationDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNatInstanceAssociationExists("ksyun_nat_instance_associate.foo", &val),
					testAccCheckNatInstanceAssociationAttributes(&val),
				),
			},
		},
	})
...
func testAccCheckNatInstanceAssociationExists(n string, val *map[string]interface{}) resource.TestCheckFunc {
...
func testAccCheckNatInstanceAssociationAttributes(val *map[string]interface{}) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		if val != nil {
