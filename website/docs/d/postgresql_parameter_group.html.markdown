...
sidebar_current: "docs-ksyun-datasource-postgresql_parameter_group"
description: |-
...
* `db_parameter_groups` - An information list of postgresql db parameter groups. Each element contains the following attributes:
  * `db_parameter_group_id` - The postgresql db parameter group id.
  * `db_parameter_group_name` - The postgresql db parameter group name.
  * `description` - The description of this db parameter group.
  * `engine_version` - The version of engine.
  * `engine` - The db parameter group adapts to what postgresql engine.
