...
sidebar_current: "docs-ksyun-datasource-postgresql"
description: |-
...
* `db_instance_type` - (Optional) HRDS_PG (highly available), RR_PG (read-only).
...
* `postgresql` - An information list of PostgreSQL.
