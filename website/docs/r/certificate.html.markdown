...
sidebar_current: "docs-ksyun-resource-certificate"
description: |-
...
```hcl
$ terraform import ksyun_certificate.default 67 b91d3c-c363-4f57-b0cd-xxxxxxxxxxxx
```
...
* `certificate_name` - (Optional) name of the certificate.
